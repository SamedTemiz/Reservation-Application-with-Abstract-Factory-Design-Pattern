...
namespace Mimari
{
    class Otel_Ucak : ISoyutFabrika
    {
        ...
        public Otel_Ucak(string sehir, string ad, int gun, int kisi, int tip, string firma, string kalkis, string varis, DateTime gidis, DateTime donus, int k_fiyat, int u_fiyat)
        {
            o_sehir = sehir;
            o_ad = ad;
            o_gun = gun;
        ...
        {
            return new Ucak(u_firma, u_kalkis, u_varis, u_gidis, u_donus, s_tip, o_kisi, u_fiyat);
        }   
    }
}
